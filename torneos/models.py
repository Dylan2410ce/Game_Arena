...
class Torneo(models.Model):
    ...
    videojuego=models.ForeignKey(Videojuego,on_delete=models.PROTECT,related_name='torneos')
...
class Inscripcion(models.Model):
    ...
    jugador=models.ForeignKey(Jugador,on_delete=models.CASCADE,related_name='inscripciones')#Si se elimina el objeto principal tambien todos los registros relacionados
